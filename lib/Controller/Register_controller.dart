...
import 'package:pas_mobile_11pplg1_14/Models/Clientnetwork.dart';
...
class RegisterController extends GetxController {
  ...
  Future<void> register() async {
    ...
    try {
      final response = await ClientNetwork.registerUser(
        username,
        password,
        fullName,
        email,
      ...
      if (response['status'] == true) {
        // Simpan email ke SharedPreferences untuk digunakan di profile nanti
